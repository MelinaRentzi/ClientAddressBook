...
if(isset($_POST['add'])) {
    ...
    // if inputs are empty, create vars with the form data and wrap the data with the function
    // name and email are required in the DB
    if(!$_POST['clientName']){
    ...
    // the rest of the inputs are not required in the DB
    $clientPhone = validateFormData($_POST['clientPhone']);
    $clientAddress = validateFormData($_POST['clientAddress']);
    $clientCompany = validateFormData($_POST['clientCompany']);
    $clientNotes = validateFormData($_POST['clientNotes']);
    
    // check to see if name and email have data
